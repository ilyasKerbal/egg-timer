...
//                val notificationManger = ContextCompat.getSystemService(app, NotificationManager::class.java) as NotificationManager
//                notificationManger.sendNotification(app.getString(R.string.timer_running), app)
